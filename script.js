...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var typed = new Typed(".element", {
      strings: ["I'm RISHBOY", "Cyber Security Expert", "Protecting Your Digital World"],
      typeSpeed: 50,
      backSpeed: 30,
      loop: true,
      backDelay: 2000
...
// GSAP Animations
gsap.from('.hero-title', { opacity: 0, duration: 1, y: -50, delay: 0.5 });
gsap.from('.hero-subtitle', { opacity: 0, duration: 1, y: -50, delay: 1 });
gsap.from('.cta-button', { opacity: 0, duration: 1, y: 50, delay: 1.5 });
...
darkModeBtn.addEventListener('click', () => {
  body.classList.remove('light-mode');
  localStorage.setItem('theme', 'dark-mode'); // Save to Local Storage
});

// Light Mode Button
lightModeBtn.addEventListener('click', () => {
  body.classList.add('light-mode');
  localStorage.setItem('theme', 'light-mode'); // Save to Local Storage
});
